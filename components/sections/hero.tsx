    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-extrabold text-white leading-tight mb-6 tracking-tight font-heading">
          Construimos con{" "}
          <span className="text-gold">calidad</span>
          <br />y compromiso
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href="#proyectos"
            className="w-full sm:w-auto bg-gold hover:bg-gold-hover text-white font-bold px-8 py-4 rounded-lg text-base transition-all duration-200 hover:shadow-lg hover:shadow-gold/20 hover:-translate-y-0.5"
          >
        ...
        <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-8 border-t border-white/10 pt-12">
          {[
            ...
            <div key={s.label} className="text-center">
              <div className="text-3xl sm:text-4xl font-extrabold text-gold font-heading">
                {s.value}
              </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/40">
        ...
        <div className="w-px h-8 bg-white/20 relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full bg-gold animate-bounce origin-top scale-y-50" />
        </div>
      </div>
    </section>
  );
